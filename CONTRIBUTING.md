...
3. **Submit PR targeting `dev`:** Open a PR targeting `dev` referencing the issue number.
4. **Review & Payout:** After merge, claim your payout at the end of the wave cycle!
